...
<div id="area">
<h2><i>DOCTORS Sign IN</i></h2>
<form name="myForm" action="doctorLogin1.php" onsubmit="return validateForm()" method="post">
  <table width="50%">
    <tbody>
      <tr>
        <td>
  ...
  <i><i><input value="Submit" style="margin-left: 200px;" align="middle" type="submit">
  </i></i></form>
</div>
